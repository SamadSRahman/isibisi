...
import mainImg from "../../assets/images/relavent/PR.jpeg"

export default function PRAndMarketing() {
  return (
    <>
      <BreadCrumb title="PR and Marketing" />
        ...
        <div className="container">
          <div className="aximo-service-details-wrap">
            ...
            <div className="col-lg-6">
              <div className="aximo-user-interface">
                <ul>
                <h3>1/ Press Release Writing & Distribution</h3>
<h3>2/ Media Relations & Outreach</h3>
<h3>3/ Crisis Management & Communication</h3>
<h3>4/ Content Marketing & Strategy</h3>
<h3>5/ Social Media Management</h3>
<h3>6/ SEO & SEM Optimization</h3>
<h3>7/ Influencer Marketing & Partnerships</h3>
<h3>8/ Digital Advertising (PPC, Display Ads)</h3>
<h3>9/ Reputation Management</h3>
<h3>10/ Creative Direction & Design</h3>
<h3>11/ Market Research & Analysis</h3>
